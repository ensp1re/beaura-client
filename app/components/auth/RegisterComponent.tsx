    ...
    return (
        <>
            <div className="grid h-screen w-full grid-cols-1 md:grid-cols-2">
                ...
                <div className='flex-1 w-full h-full flex flex-col items-center justify-center bg-gray-50'>
                    <div className="flex items-center justify-between w-full px-4 py-4 border-b border-gray-300">
                        <div className="w-8 h-8 bg-gray-300 rounded-full"></div>
                    </div>
                    <div className='w-full flex-1 flex bg-white items-center justify-center px-4'>
                        <RegisterForm />
                    </div>
                </div>
            </div>
